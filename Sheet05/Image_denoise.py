            ...
            for x in range(I.shape[0] - 1):
                for y in range(I.shape[1]):
                    if I[x, y] == alpha and I[x + 1, y] == alpha:
                        ...
                        g.add_edge(nodes[x + 1, y], nodes[x, y], 0, pairwiseCost)
                        ...
                        g.add_edge(nodes[x + 1, y], new_node, pairwiseCost, infinite_cost)
                        g.add_tedge(new_node, 0, pairwiseCost)
            ...
            for x in range(I.shape[0]):
                for y in range(I.shape[1] - 1):
                    if I[x, y] == alpha and I[x, y + 1] == alpha:
                        ...
                        pairwiseCost = potts_cost(alpha, beta)
                        g.add_edge(nodes[x, y + 1], nodes[x, y], 0, pairwiseCost)
                        ...
                        pairwiseCost = potts_cost(gamma, beta)
                        g.add_edge(nodes[x, y], new_node, pairwiseCost, infinite_cost)
                        g.add_edge(nodes[x, y + 1], new_node, pairwiseCost, infinite_cost)
                        g.add_tedge(new_node, 0, pairwiseCost)
